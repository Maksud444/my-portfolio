      ...
      <div className='container mx-auto h-full mb-6 mt-7'>
        <div className='flex items-center h-full pt-8'>
          <div className='flex-1 flex flex-col items-center lg:items-start' >
            ...
            <h1  className='text-3xl leading-[34px] md:text-5xl md:leading-tight lg:text-5xl lg:leading-[1.2] font-bold md:tracking-[-2px]'>
            Hi, I Am   {' '}
        <span className='text-accent text-bold text-5xl'>
